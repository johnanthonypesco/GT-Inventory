...
class ReviewManagerController extends Controller
{
    ...
    public function approve(Review $review)
    {
        ...
        HistorylogController::add('Approve', 'Review of Customer:' . $review->user->name . ' has been approved by ');
    ...
    public function disapprove(Review $review)
    {
        ...
        HistorylogController::add('Disapprove', 'Review of Customer: ' . $review->user->name . ' has been disapproved by ' );
