    ...
    <main class="md:w-full h-full lg:ml-[16%] ml-0">
        ...
        <div class="flex flex-col bg-white mt-5 p-5 rounded-lg">
            <div class="flex flex-col gap-2">
                <div class="mb-2">
                    <div class="customer-container flex items-center gap-2 p-3 rounded-lg cursor-pointer hover:bg-gray-100 transition"
                ...
                <div id="chat-list" class="h-[50vh] overflow-auto">
                    @unless($superAdmins->isEmpty())
                        ...
                        @foreach($superAdmins as $superAdmin)
                            <div class="customer-container flex items-center justify-between gap-2 p-3 rounded-lg cursor-pointer hover:bg-gray-100 transition"
