...
<body class="flex items-center justify-center h-screen p-10">
  ...
  <div class="flex flex-col lg:flex-row shadow-lg rounded-lg bg-white w-full lg:w-[55%] overflow-hidden">
    ...
    <div class="flex flex-col gap-2 w-full lg:w-1/2 p-6 md:p-10">
      ...
      <h1 class="text-center mt-5 font-medium tracking-wide text-lg md:text-xl">Sign in to your Account</h1>
      <h1 class="text-xs md:text-sm text-center text-[#005382]/85">Manage your Medication Effortlessly Anytime, Anywhere</h1>

      <form action="#" class="mt-6 space-y-5">
        <div>
        ...
        <button type="submit" 
          class="bg-[#15ABFF] w-full p-3 rounded-lg text-white mt-5 cursor-pointer hover:-translate-y-1 transition-transform duration-300 text-sm md:text-base">
          Sign in
        </button>
      </form>
    </div>
