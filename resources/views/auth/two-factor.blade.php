...
<body>
    <div class="flex flex-col lg:flex-row p-5 lg:gap-60 gap-5 items-center justify-center">
        <div>
            <img src="{{ asset('image/Group 41.png') }}" class="lg:w-[300px] w-[200px] mt-10 lg:mt-0 m-auto">
        </div>

        <div class="w-full lg:w-[500px]">
            <form method="POST" action="{{ route('2fa.check') }}" class="w-full p-5 flex flex-col h-fit lg:bg-white/0 bg-white rounded-lg">
                @csrf
