...
<div class="flex flex-col gap-2 h-full w-0 fixed top-0 -left-20 bg-white z-20 p-5 list-none transition-all duration-500" id="sidebar">
    <div>
        <img src="{{ asset('image/Group 39.png') }}">
        <hr class="mt-2">
    </div>
