...
<div class="sidebar fixed top-0 -left-32 w-0 h-full flex flex-col bg-white z-20 gap-1 p-10 transition-all duration-500" id="sidebar">
    ...
    @if (auth('superadmin')->check())
        ...
        <a href="{{ route ('admin.contentmanagement')}}" class="text-md"><i class="fa-solid fa-file text-[#005382] text-md"></i>Manage Content</a>
        
        <a href="{{ route('superadmin.reviews.index') }}" class="text-md"><i class="fa-solid fa-star text-[#005382] text-md"></i>Review Manager </a>
