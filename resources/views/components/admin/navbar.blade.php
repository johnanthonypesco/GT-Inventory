<nav id="sidebar" class="md:w-[15%] w-full hidden lg:flex flex-col p-3 fixed top-4 left-4">
    ...
    <li class="list-none flex flex-col p-2 gap-[3px] h-full">
        ...
        @if (auth('superadmin')->check() || auth('admin')->check())
            ...
            <a href="{{ route('admin.sales') }}" class="text-sm sm:flex sm:justify-center lg:flex lg:justify-start items-center gap-2 hover:animate-spin">
            ...
            <a href="{{ route('superadmin.account.index') }}" class="text-sm sm:flex sm:justify-center lg:flex lg:justify-start items-center gap-2 hover:animate-spin">
            ...
            <a href="{{ route('admin.history') }}" class="text-sm sm:flex sm:justify-center lg:flex lg:justify-start items-center gap-2 {{ request()->is('admin/history') ? 'active' : ''  }} hover:animate-spin">
